...
``````{r, echo = FALSE, code = readLines("chart_1.R"), fig.width = 10, fig.height = 5}
```
...
``````{r, echo = FALSE, code = readLines("chart_2.R"), fig.width = 10, fig.height = 5}
```
...
``````{r, echo = FALSE, code = readLines("chart_3.R"), fig.width = 10, fig.height = 5}
```
